...
#SER = 4.0
#
#(solve "...........98....7.8..6..5..5..4..3...79....2...........27....9.4..5..6.3....62..")
#
#
#***********************************************************************************************
...
#***********************************************************************************************
#...........98....7.8..6..5..5..4..3...79....2...........27....9.4..5..6.3....62..
#21 givens, 252 candidates
#entering BRT
#Starting_init_links_with_<Fact-3704>
#252 candidates, 1927 csp-links and 1927 links. Density = 6.09%
#starting non trivial part of solution
#Entering_level_W1_with_<Fact-10903>
#Entering_relation_bivalue_with_<Fact-10904>
#Entering_level_S2_with_<Fact-10983>
#hidden-pairs-in-a-block: b7{r8c1 r9c2}{n7 n9} ==> r9c2 ≠ 1, r8c1 ≠ 8, r8c1 ≠ 1
#Entering_level_S3_with_<Fact-10994>
...
#hidden-single-in-a-column ==> r1c6 = 3
...
#naked-single ==> r7c6 = 8
#naked-single ==> r7c2 = 1
#GRID 0 SOLVED. rating-type = S, MOST COMPLEX RULE TRIED = SHT
#124573896
#569814327
#783269154
#251647938
...
#948152763
#375496281
#Puzzle ...........98....7.8..6..5..5..4..3...79....2...........27....9.4..5..6.3....62.. :
#init-time = 0.19s, solve-time = 0.23s, total-time = 0.42s
#nb-facts=<Fact-11369>
#***********************************************************************************************
#***  SudoRules 20.1.s based on CSP-Rules 2.1.s, config = S
#***  Using CLIPS 6.32-r770
