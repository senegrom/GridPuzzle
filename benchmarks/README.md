...
| 09-25 | als_enumerator_merge (.md/.json) | accepted | the ALS pass and Sue de Coq share `iter_als`; identical on 127,344 live calls and every fingerprint; whole solves −2.2% to +4.2% within overlapping ranges (example `t` −2.2%), the ALS pass's own enumeration −47% |
