...
used for each accepted optimization or measured baseline.
...
| 08-09 | silent_logging | accepted | −1.89% silent API use |
| 08-09 | direct_action_dispatch | accepted | closure-free dispatch, −0.57% |
